...
[79,70,79,70,79,70,79,70, 77,70,77,70,77,70,75,70, 79,70,79,70,79,70,79,70, 77,70,77,70,77,70,75,70,
75,70,75,77,77,70,77,70, 75,70,75,77,77,70,77,70, 78,70,78,77,77,70,77, 0,0,0,0,0,0,
79,70,79,70,79,70,79,70, 77,70,77,70,77,70,75,70, 79,70,79,70,79,70,79,70, 77,70,77,70,77,70,75,70,
75,70,75,77,77,70,77,70, 75,70,75,77,77,70,77,70, 78,70,78,77,77,70,77, 0,0,0,0,0,0
] @=> int melody[]; 
...
for (0 => int i; i < durs.size(); i++) {
    if(melody[i] == 0) {
        sendOutMIDInote(1,chords[i][0], 77);
        sendOutMIDInote(1,chords[i][1], 77);   
        durs[i] => now;
        
        sendOutMIDInote(0,chords[i][0], 77);
        sendOutMIDInote(0,chords[i][1], 77);  
        0.00001::second => now;     
        }
    else {
        sendOutMIDInote(1,melody[i], 77);
        durs[i] => now;
        
        sendOutMIDInote(0, melody[i], 77);
        0.00001::second => now;
        }  
} 
